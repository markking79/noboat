...
@section('page-title') Packs @endsection
...
@section('content')
    ...
    @if (!$packs->isEmpty ())
        @foreach ($packs->chunk (3) as $chunked_packs)
            <div class="row view-packs-content">
                @foreach ($chunked_packs as $pack)
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="card">
                            <a href="{{route ('packs.show', ['pack' => $pack])}}">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    @endif
                                    @if ($pack->visible_cost)
                                        ${{number_format ($pack->visible_cost, 2)}}<br />
                                    @endif

                                    {{$pack->visible_item_count  ?? "0"}} items
                                </p>
                                <a href="{{route ('packs.show', ['pack' => $pack])}}" class="btn btn-primary btn-sm">View</a>
                            </div>
                        </div>
                        <br />
                    </div>
